...
"""
Usage:
    pytest test_randperm_perf.py --level core --warmup 1000 --iter 1000 \
...
def randperm_input_fn(shape, cur_dtype, device):
    yield {"n": shape[0], "dtype": cur_dtype, "device": device},
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            torch.randperm,
            randperm_input_fn,
            marks=pytest.mark.randperm,
        ),
    ],
)
def test_randperm_benchmark(op_name, torch_op, input_fn):
