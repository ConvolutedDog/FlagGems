...
"""
Usage:
    pytest test_upsample_bicubic2d_aa_perf.py --level core --warmup 1000 --iter 1000 \
...
class UPSAMPLEBICUBIC2DAABenchmark(GenericBenchmark):
    """Benchmark for upsample_bicubic2d_aa."""
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            upsample_bicubic2d_aa_input_fn,
            marks=pytest.mark.upsample_bicubic2d_aa,
        ),
    ],
)
def test_perf_upsample_bicubic2d_aa(op_name, torch_op, input_fn):
    bench = UPSAMPLEBICUBIC2DAABenchmark(
        input_fn=input_fn,
        op_name=op_name,
        torch_op=torch_op,
        dtypes=FLOAT_DTYPES,
