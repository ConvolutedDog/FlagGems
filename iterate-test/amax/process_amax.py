...
# ===================================
input_log = "results/amax-result.txt"
output_excel = (
    "results/amax-result-512-512-8192-512-512-8192-512-512-8192-512-512-8192.csv"
)
# ===================================
    ...
    if line.startswith("[INFO]"):
        ...
        for result in results:
            ...
            row = {
                ...
                "shape_detail_N": shape_detail[0][0],
                "shape_detail_C": shape_detail[0][1],
                "shape_detail_H": shape_detail[0][2],
                "shape_detail_W": shape_detail[0][3],
                "form_detail_dim": shape_detail[1],
