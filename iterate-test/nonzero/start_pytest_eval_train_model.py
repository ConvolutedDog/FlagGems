...
excel_config = {
    ...
    # Auto-tune configs.
    "config_cols": ["blocks", "warps", "stages"],
    # Performance.
    "latency_col": "latency",
    # Benchmark name of shape yaml.
    "bench_name": "NONZEROBenchmark",
...
def gen_blocks(shape_detail_M, shape_detail_N):
    """
...
tunedconfiggen = TunedConfigGenerator(
    excel_config,
    (gen_blocks, gen_warps, gen_stages),
    shapegen,
)
