...
excel_config = {
    ...
    "shape_cols": [
        ...
        "shape_detail_H",
        "shape_detail_W",
        "form_detail_diagonal",
    ],
    # Auto-tune configs.
    "config_cols": ["block_m", "block_n", "warps"],
    # Performance.
    "latency_col": "latency",
    # Benchmark name of shape yaml.
    "bench_name": "TRIUBenchmark",
