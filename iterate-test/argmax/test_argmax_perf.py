...
"""
Usage:
    pytest test_argmax_perf.py --level core --warmup 1000 --iter 1000 \
...
def argmax_input_fn(shape, cur_dtype, device):
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            "argmax",
            torch.argmax,
            marks=pytest.mark.argmax,
        ),
    ],
)
def test_argmax_benchmark(op_name, torch_op):
