...
pytest_operation_name = "log_softmax"
...
excel_config = {
    ...
    "bench_name": "LOGSOFTMAXBenchmark",
...
def gen_BLOCK_M(
    ...
    """
    res = 5.02754660e-5 * shape_detail_N + 5.70746029e-05 * shape_detail_C + 0.951953125
...
def gen_BLOCK_N(
    ...
    """
    res = 4.52714808e-05 * shape_detail_N + 3.63630407e-05 * shape_detail_C + 0.52656250
