...
"""
Usage:
    pytest test_log_softmax_perf.py --level core --warmup 1000 --iter 1000 \
...
def log_softmax_input_fn(shape, cur_dtype, device):
    (
        shape_detail_N,
        shape_detail_C,
        shape_detail_H,
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            log_softmax_input_fn,
            marks=pytest.mark.log_softmax,
        ),
    ],
)
def test_log_softmax_benchmark(op_name, torch_op, input_fn):
