...
# ===================================
input_log = "results/var_mean-result.txt"
output_excel = (
    "results/var_mean-result-512-512-8192-512-512-8192-512-512-8192-512-512-8192.csv"
)
# ===================================
    ...
    if line.startswith("[INFO]"):
        ...
        for result in results:
            ...
            row = {
                ...
                "form_detail_dim": shape_detail["dim"]
                if "dim" in shape_detail
                else None,
