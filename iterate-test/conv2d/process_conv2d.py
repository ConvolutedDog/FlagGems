    ...
    if line.startswith("[INFO]"):
        ...
        for result in results:
            ...
            row = {
                ...
                "shape_detail_B": shape_detail["input"][0],
                "shape_detail_Cin": shape_detail["input"][1],
                "shape_detail_H": shape_detail["input"][2],
                "shape_detail_W": shape_detail["input"][3],
                "shape_detail_Cout": shape_detail["weight"][0],
                "shape_detail_Kh": shape_detail["weight"][2],
                "shape_detail_Kw": shape_detail["weight"][3],
